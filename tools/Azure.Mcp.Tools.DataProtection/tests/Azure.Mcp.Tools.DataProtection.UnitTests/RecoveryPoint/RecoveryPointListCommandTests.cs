...
public class RecoveryPointListCommandTests
{
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsRecoveryPoints_WhenRecoveryPointsExist()
    {
        var expected = new RecoveryPointModel[] { new() { Name = "rp1" }, new() { Name = "rp2" } };
        _service.ListRecoveryPointsAsync("instance1", "vault1", "rg1", "sub123", Arg.Any<string?>(), Arg.Any<RetryPolicyOptions?>(), Arg.Any<CancellationToken>())
            .Returns(expected);

        var command = new RecoveryPointListCommand(_logger);
        ...
        var result = JsonSerializer.Deserialize(json, DataProtectionJsonContext.Default.RecoveryPointListCommandResult);
    ...
    {
        _service.ListRecoveryPointsAsync("instance1", "vault1", "rg1", "sub123", Arg.Any<string?>(), Arg.Any<RetryPolicyOptions?>(), Arg.Any<CancellationToken>())
            .Returns(Array.Empty<RecoveryPointModel>());
