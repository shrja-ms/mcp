...
public class RecoveryPointArchiveCommandTests
{
    private readonly IAzureBackupService _backupService;
    private readonly RecoveryPointArchiveCommand _command;
    private readonly CommandContext _context;
    private readonly Command _commandDefinition;

    public RecoveryPointArchiveCommandTests()
    {
        _backupService = Substitute.For<IAzureBackupService>();
        var logger = Substitute.For<ILogger<RecoveryPointArchiveCommand>>();
    ...
    [Fact]
    public async Task ExecuteAsync_ArchivesRecoveryPoint_Successfully()
    {
        var expectedResult = new OperationResult("Succeeded", null, "Recovery point archived");
        _backupService.MoveRecoveryPointToArchiveAsync(
        ...
        var result = JsonSerializer.Deserialize(json, AzureBackupJsonContext.Default.RecoveryPointArchiveCommandResult);
