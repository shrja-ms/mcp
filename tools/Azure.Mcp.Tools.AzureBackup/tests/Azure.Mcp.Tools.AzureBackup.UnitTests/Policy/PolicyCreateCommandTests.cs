...
public class PolicyCreateCommandTests
{
    ...
    public PolicyCreateCommandTests()
    {
        ...
        var logger = Substitute.For<ILogger<PolicyCreateCommand>>();
    ...
    {
        var expectedResult = new OperationResult("Succeeded", null, "Policy created");
        ...
        var args = _commandDefinition.Parse(["--subscription", "sub123", "--resource-group", "rg1", "--vault", "vault1", "--policy", "pol1", "--workload-type", "VM"]);
