...
public class BulkTriggerCommandTests
{
    private readonly IAzureBackupService _backupService;
    private readonly BulkTriggerCommand _command;
    private readonly CommandContext _context;
    private readonly Command _commandDefinition;

    public BulkTriggerCommandTests()
    {
        _backupService = Substitute.For<IAzureBackupService>();
        var logger = Substitute.For<ILogger<BulkTriggerCommand>>();
    ...
    [Fact]
    public async Task ExecuteAsync_BulkTriggersBackup_Successfully()
    {
        var expectedResult = new OperationResult("Succeeded", null, "Operation completed");
        _backupService.BulkTriggerBackupAsync(
        ...
        var result = JsonSerializer.Deserialize(json, AzureBackupJsonContext.Default.BulkTriggerCommandResult);
