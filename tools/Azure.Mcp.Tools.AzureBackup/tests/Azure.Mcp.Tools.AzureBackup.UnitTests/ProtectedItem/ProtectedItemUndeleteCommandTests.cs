...
public class ProtectedItemUndeleteCommandTests
{
    ...
    public ProtectedItemUndeleteCommandTests()
    {
        ...
        var logger = Substitute.For<ILogger<ProtectedItemUndeleteCommand>>();
    ...
    [Fact]
    public async Task ExecuteAsync_UndeletesProtectedItem_Successfully()
    {
        var expectedResult = new OperationResult("Succeeded", null, "Protected item undeleted");
