...
public class GovernanceFindUnprotectedCommandTests
{
    ...
    public GovernanceFindUnprotectedCommandTests()
    {
        ...
        var logger = Substitute.For<ILogger<GovernanceFindUnprotectedCommand>>();
    ...
    {
        var expectedResult = new List<UnprotectedResourceInfo>
        {
            new("id1", "vm1", "Microsoft.Compute/virtualMachines", "rg1", "eastus", null)
        };
