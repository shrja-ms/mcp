...
public class GovernanceSoftDeleteCommandTests
{
    ...
    public GovernanceSoftDeleteCommandTests()
    {
        ...
        var logger = Substitute.For<ILogger<GovernanceSoftDeleteCommand>>();
    ...
    {
        var expectedResult = new OperationResult("Succeeded", null, "Soft delete configured");
        ...
        var args = _commandDefinition.Parse(["--subscription", "sub123", "--resource-group", "rg1", "--vault", "vault1", "--soft-delete", "AlwaysOn"]);
