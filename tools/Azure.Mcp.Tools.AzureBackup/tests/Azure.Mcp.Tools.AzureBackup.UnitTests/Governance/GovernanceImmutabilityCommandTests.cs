...
public class GovernanceImmutabilityCommandTests
{
    ...
    public GovernanceImmutabilityCommandTests()
    {
        ...
        var logger = Substitute.For<ILogger<GovernanceImmutabilityCommand>>();
    ...
    {
        var expectedResult = new OperationResult("Succeeded", null, "Immutability configured");
        ...
        var args = _commandDefinition.Parse(["--subscription", "sub123", "--resource-group", "rg1", "--vault", "vault1", "--immutability-state", "Enabled"]);
